                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="space-y-2">
                            ...
                            <Button
                                ...
                                className="h-auto min-h-11 w-full justify-between rounded-xl border-dashed border-2 hover:border-primary/50 hover:bg-primary/5 px-4 py-2"
                            >
                                <div className="flex items-center gap-2 text-left min-w-0 flex-1">
                                    ...
                                    <span className={cn(
                                        ...
                                        {form.descripcion || "Agregar detalles adicionales..."}
                                    </span>
                                </div>
